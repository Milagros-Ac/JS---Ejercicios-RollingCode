...
Dificultad:  🟢🟡*/
let numeros = Number(prompt("Introduce un número:"));

if (numeros % 2 === 0) {
    console.log(`El ${numeros} es divisible por 2.`);
} else if (numeros % 3 === 0) {
    console.log(`El ${numeros} es divisible por 3.`);
} else if (numeros % 5 === 0) {
    console.log(`El ${numeros} es divisible por 5.`);
} else if (numeros % 7 === 0) {
    console.log(`El ${numeros} es divisible por 7.`);
} else {
